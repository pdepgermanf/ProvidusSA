...
public class InterfazEliminarCliente extends Interfaz {
    ...
    public InterfazEliminarCliente(Main control){
        super(control);
        iniciarPanelSuperior();
        iniciarPanelCentral();
        control.getVentana().setTitle("Eliminar");
        new ControladorEliminarCliente(this,control);
    }
    ...
    protected void iniciarPanelCentral() {
        ...
        contenedorNodos.add(botonEliminar, 1, nodos.length+1);
