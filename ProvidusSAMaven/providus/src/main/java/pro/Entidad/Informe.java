...
public class Informe {
    ...
    private ArrayList<Fila> entradas;
    private String tipoDeInforme;

    public Informe(int idInforme, String tipoDeInforme, String titulo,String fecha) {
        this.fecha = fecha;
        this.titulo = titulo;
    ...
    public Informe(String titulo,String tipoDeInforme) {
